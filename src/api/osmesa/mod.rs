#![cfg(any(target_os = "linux", target_os = "dragonfly", target_os = "freebsd", target_os = "netbsd", target_os = "openbsd", target_os = "redox"))]
...
impl OsMesaContext {
    ...
    ) -> Result<OsMesaContext, CreationError>
    {
        ...
        attribs.push(osmesa_sys::OSMESA_STENCIL_BITS);
        attribs.push(8);

        attribs.push(osmesa_sys::OSMESA_ACCUM_BITS);
        attribs.push(0);
